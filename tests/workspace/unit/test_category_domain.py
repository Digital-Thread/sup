...
@pytest.fixture()
def category_minimal(workspace_id) -> CategoryEntity:
...
@pytest.fixture()
def category_full(workspace_id) -> CategoryEntity:
    return CategoryEntity(_workspace_id=workspace_id, _name='Full Category', _id=CategoryId(1))


class TestCategoryCreation:

    def test_category_creation_with_required_data(
        self, category_minimal: CategoryEntity, workspace_id
    ) -> None:
...
class TestCategoryValidation:
    ...
    def test_valid_category_name(self, category_minimal: CategoryEntity, name: str) -> None:
    ...
    def test_invalid_category_name(
        self, category_minimal: CategoryEntity, name: str, expected_error_message: str
    ) -> None:
