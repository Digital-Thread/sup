...
async def get_projects_by_workspace_id(
    workspace_id: WorkspaceId, use_case: FromDishka[GetProjectByWorkspaceUseCase]
...
async def delete_project(
    project_id: ProjectId, workspace_id: WorkspaceId, use_case: FromDishka[DeleteProjectUseCase]
) -> dict[str, str]:
    try:
