...
class GetCategoryByIdInteractor:
    ...
    async def execute(self, category_id: CategoryId, workspace_id: WorkspaceId) -> CategoryAppDTO:
        try:
            category = await self._category_repository.find_by_id(category_id, workspace_id)
